...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // SOCKET
        var webSocket = new WebSocket('ws://192.168.1.139:8765');
    ...
    function newLife() {
        ...
        var snake1 = new Snake('0', Math.random() * CANVAS_WIDTH, Math.random() * CANVAS_HEIGHT, CANVAS_WIDTH, CANVAS_HEIGHT);
